...
import { PEARL_URL } from '@/supafund/core/constants/urls';
import { useMainOlasBalance } from '@/supafund/core/providers/SharedProvider/useMainOlasBalance';
...
export const NotifyRewardsModal = () => {
  ...
  useEffect(() => {
    ...
    if (hasScheduledNotificationRef.current) return;

    firstRewardRef.current = availableRewardsForEpochEth;
    setCanShowNotification(true);
    hasScheduledNotificationRef.current = true;
