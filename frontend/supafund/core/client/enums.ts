import { ValueOf } from '@/supafund/core/types/Util';
 ...
 *
 * @deprecated Use `MiddlewareChain` from '@/supafund/core/constants/chains'.
 */
...
/**
 * @deprecated Use `SupportedMiddlewareChainMap` from '@/supafund/core/constants/chains'.
 */
...
/**
 * @deprecated Use `SupportedMiddlewareChain` from '@/supafund/core/constants/chains'.
 */
export type SupportedMiddlewareChain = ValueOf<typeof MIDDLEWARE_CHAINS>;

/**
 * @deprecated Use `MiddlewareDeploymentStatusMap` from '@/supafund/core/constants/deployment'.
 */
