import { MiddlewareChain, MiddlewareWalletResponse } from '@/supafund/core/client';
import { CONTENT_TYPE_JSON_UTF8 } from '@/supafund/core/constants/headers';
import { BACKEND_URL } from '@/supafund/core/constants/urls';
import { SafeCreationResponse } from '@/supafund/core/types/Wallet';
