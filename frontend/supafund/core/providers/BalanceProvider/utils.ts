...
import { MiddlewareChain, MiddlewareServiceResponse } from '@/supafund/core/client';
import { providers } from '@/supafund/core/config/providers';
import { TOKEN_CONFIG, TokenType } from '@/supafund/core/config/tokens';
import { EvmChainId } from '@/supafund/core/enums/Chain';
import { ServiceRegistryL2ServiceState } from '@/supafund/core/enums/ServiceRegistryL2ServiceState';
import {
  AgentWallet,
  MasterSafe,
  MasterWallet,
  Wallet,
  WalletType,
} from '@/supafund/core/enums/Wallet';
import { StakedAgentService } from '@/supafund/core/services/agents/shared-services/StakedAgentService';
import { CrossChainStakedBalances, WalletBalance } from '@/supafund/core/types/Balance';
import { asEvmChainId } from '@/supafund/core/utils/middlewareHelpers';
import { formatUnits } from '@/supafund/core/utils/numberFormatters';
import { isValidServiceId } from '@/supafund/core/utils/service';
