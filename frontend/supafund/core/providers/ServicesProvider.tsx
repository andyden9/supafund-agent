...
import { AGENT_CONFIG } from '@/supafund/core/config/agents';
...
import { MESSAGE_WIDTH } from '@/supafund/core/constants/width';
...
import { UsePause, usePause } from '@/supafund/core/hooks/usePause';
...
import { Service } from '@/supafund/core/types/Service';
import { Maybe, Nullable, Optional } from '@/supafund/core/types/Util';
import { isNilOrEmpty } from '@/supafund/core/utils/lodashExtensions';
...
export const ServicesProvider = ({ children }: PropsWithChildren) => {
  ...
  const updateAgentType = useCallback((agentType: AgentType) => {
    store?.set?.('lastSelectedAgentType', AgentType.Supafund);
