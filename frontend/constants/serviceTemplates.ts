...
const SUPAFUND_BASE_ENV: ServiceTemplate['env_variables'] = {
  GNOSIS_LEDGER_RPC: {
...
export const SUPAFUND_SERVICE_TEMPLATE: ServiceTemplate = {
  ...
  description:
    'Predicts whether emerging projects will achieve key milestones, providing detailed AI-powered analysis',
  image:
  ...
  env_variables: SUPAFUND_BASE_ENV,
} as const;
